...
# 定义输出目录和可执行文件名
BIN_DIR = ../../bin
TARGET = $(BIN_DIR)/Sec_Client

# 定义源文件目录
SRC_DIR = ../../src
SHARE_DIR = $(SRC_DIR)/share
SEC_CLIENT_DIR = $(SRC_DIR)/Sec_Client
...
SEC_CLIENT_SRCS = $(SEC_CLIENT_DIR)/Codec.cpp \
                                  $(SEC_CLIENT_DIR)/main.cpp \
								  $(SEC_CLIENT_DIR)/Message.pb.cc \
                                  $(SEC_CLIENT_DIR)/RequestCodec.cpp \
								  $(SEC_CLIENT_DIR)/ResponCodec.cpp \
								  $(SEC_CLIENT_DIR)/SecClient.cpp
