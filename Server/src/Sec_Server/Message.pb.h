...
class RespondMsg :
 ...
 public:
  ...
  // int32 seckeyID = 4;
  void clear_seckeyid();
  static const int kSeckeyIDFieldNumber = 4;
...
inline ::PROTOBUF_NAMESPACE_ID::int32 RequestMsg::serverid() const {
  // @@protoc_insertion_point(field_get:RequestMsg.serverId)
  return serverid_;
}
inline void RequestMsg::set_serverid(::PROTOBUF_NAMESPACE_ID::int32 value) {
...
inline ::PROTOBUF_NAMESPACE_ID::int32 RequestMsg::clientid() const {
  // @@protoc_insertion_point(field_get:RequestMsg.clientID)
  return clientid_;
}
inline void RequestMsg::set_clientid(::PROTOBUF_NAMESPACE_ID::int32 value) {
...
inline ::PROTOBUF_NAMESPACE_ID::int32 RespondMsg::serverid() const {
  // @@protoc_insertion_point(field_get:RespondMsg.serverId)
  return serverid_;
}
inline void RespondMsg::set_serverid(::PROTOBUF_NAMESPACE_ID::int32 value) {
...
inline ::PROTOBUF_NAMESPACE_ID::int32 RespondMsg::clientid() const {
  // @@protoc_insertion_point(field_get:RespondMsg.clientID)
  return clientid_;
}
inline void RespondMsg::set_clientid(::PROTOBUF_NAMESPACE_ID::int32 value) {
