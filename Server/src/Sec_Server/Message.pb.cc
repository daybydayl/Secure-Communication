...
RequestMsg::RequestMsg(const RequestMsg& from)
  ...
  ::memcpy(&serverid_, &from.serverid_,
    static_cast<size_t>(reinterpret_cast<char*>(&cmdtype_) -
    reinterpret_cast<char*>(&serverid_)) + sizeof(cmdtype_));
...
void RequestMsg::SerializeWithCachedSizes(
  ...
  // int32 serverId = 1;
  if (this->serverid() != 0) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteInt32(1, this->serverid(), output);
  }

  // int32 clientID = 2;
  if (this->clientid() != 0) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteInt32(2, this->clientid(), output);
  }

  // int32 cmdType = 3;
  if (this->cmdtype() != 0) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteInt32(3, this->cmdtype(), output);
  }
...
::PROTOBUF_NAMESPACE_ID::uint8* RequestMsg::InternalSerializeWithCachedSizesToArray(
  ...
  // int32 serverId = 1;
  if (this->serverid() != 0) {
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteInt32ToArray(1, this->serverid(), target);
  }

  // int32 clientID = 2;
  if (this->clientid() != 0) {
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteInt32ToArray(2, this->clientid(), target);
  }

  // int32 cmdType = 3;
  if (this->cmdtype() != 0) {
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteInt32ToArray(3, this->cmdtype(), target);
  }
...
RespondMsg::RespondMsg(const RespondMsg& from)
  ...
  ::memcpy(&serverid_, &from.serverid_,
    ...
    reinterpret_cast<char*>(&serverid_)) + sizeof(seckeyid_));
...
void RespondMsg::SerializeWithCachedSizes(
  ...
  // bool status = 3;
  if (this->status() != 0) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteBool(3, this->status(), output);
  }

  // int32 seckeyID = 4;
  if (this->seckeyid() != 0) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteInt32(4, this->seckeyid(), output);
  }
...
::PROTOBUF_NAMESPACE_ID::uint8* RespondMsg::InternalSerializeWithCachedSizesToArray(
  ...
  // bool status = 3;
  if (this->status() != 0) {
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteBoolToArray(3, this->status(), target);
  }

  // int32 seckeyID = 4;
  if (this->seckeyid() != 0) {
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteInt32ToArray(4, this->seckeyid(), target);
  }
